export const countries = [
  ...
  { code: "AX", states: [], capital: "Mariehamn", name: "Aland Islands" },
  {
    code: "AL",
    states: [
  ...
  { code: "AS", states: [], capital: "Pago Pago", name: "American Samoa" },
  {
    code: "AD",
    states: [
  ...
  { code: "AI", states: [], capital: "The Valley", name: "Anguilla" },
  { code: "AQ", states: [], capital: "", name: "Antarctica" },
  {
    code: "AG",
    states: [
  ...
  { code: "AW", states: [], capital: "Oranjestad", name: "Aruba" },
  {
    code: "AU",
    states: [
  ...
  },
  {
    code: "BH",
    states: [
      { name: "Capital", state_code: "13" },
      { name: "Central", state_code: "16" },
      { name: "Muharraq", state_code: "15" },
      { name: "Northern", state_code: "17" },
      { name: "Southern", state_code: "14" }
    ],
    capital: "Manama",
    name: "Bahrain"
  },
  ...
  { code: "BV", states: [], capital: "", name: "Bouvet Island" },
  {
    code: "BR",
    states: [
  ...
  },
  {
    code: "KH",
    states: [
      { name: "Banteay Meanchey", state_code: "1" },
  ...
  { code: "KY", states: [], capital: "George Town", name: "Cayman Islands" },
  {
    code: "CF",
    states: [
  ...
  },
  {
    code: "CL",
    states: [
      { name: "Aisén del General Carlos Ibañez del Campo", state_code: "AI" },
  ...
  { code: "CK", states: [], capital: "Avarua", name: "Cook Islands" },
  {
    code: "CR",
    states: [
  ...
  },
  {
    code: "HR",
    states: [
      { name: "Bjelovar-Bilogora", state_code: "07" },
      { name: "Brod-Posavina", state_code: "12" },
      { name: "Dubrovnik-Neretva", state_code: "19" },
      { name: "Istria", state_code: "18" },
      { name: "Karlovac", state_code: "04" },
      { name: "Koprivnica-Križevci", state_code: "06" },
      { name: "Krapina-Zagorje", state_code: "02" },
      { name: "Lika-Senj", state_code: "09" },
      { name: "Međimurje", state_code: "20" },
      { name: "Osijek-Baranja", state_code: "14" },
      { name: "Požega-Slavonia", state_code: "11" },
      { name: "Primorje-Gorski Kotar", state_code: "08" },
      { name: "Šibenik-Knin", state_code: "15" },
      { name: "Sisak-Moslavina", state_code: "03" },
      { name: "Split-Dalmatia", state_code: "17" },
      { name: "Varaždin", state_code: "05" },
      { name: "Virovitica-Podravina", state_code: "10" },
      { name: "Vukovar-Syrmia", state_code: "16" },
      { name: "Zadar", state_code: "13" },
      { name: "Zagreb", state_code: "01" },
  ...
  { code: "CW", states: [], capital: "Willemstad", name: "Curaçao" },
  {
    code: "CY",
    states: [
      { name: "Famagusta District (Mağusa)", state_code: "04" },
  ...
  },
  {
    code: "EG",
    states: [
      { name: "Alexandria", state_code: "ALX" },
  ...
  { code: "FK", states: [], capital: "Stanley", name: "Falkland Islands" },
  { code: "FO", states: [], capital: "Torshavn", name: "Faroe Islands" },
  {
    code: "FJ",
    states: [
  ...
  { code: "GF", states: [], capital: "Cayenne", name: "French Guiana" },
  { code: "PF", states: [], capital: "Papeete", name: "French Polynesia" },
  {
    code: "TF",
    states: [],
  ...
  { code: "GI", states: [], capital: "Gibraltar", name: "Gibraltar" },
  {
    code: "GR",
    states: [
  ...
  { code: "GL", states: [], capital: "Nuuk", name: "Greenland" },
  {
    code: "GD",
    states: [
  ...
  { code: "GP", states: [], capital: "Basse-Terre", name: "Guadeloupe" },
  { code: "GU", states: [], capital: "Hagatna", name: "Guam" },
  {
    code: "GT",
    states: [
  ...
  },
  {
    code: "HK",
    states: [
      { name: "Central and Western District", state_code: "HCW" },
  ...
  },
  {
    ...
    states: [
      ...
      { name: "Baranya", state_code: "BA" },
      { name: "Békés", state_code: "BE" },
      { name: "Békéscsaba", state_code: "BC" },
      { name: "Borsod-Abaúj-Zemplén", state_code: "BZ" },
  ...
  },
  {
    ...
    states: [
      ...
      { name: "Al Muthanna", state_code: "MU" },
      { name: "Al-Qādisiyyah", state_code: "QA" },
      { name: "Babylon", state_code: "BB" },
      { name: "Baghdad", state_code: "BG" },
      { name: "Basra", state_code: "BA" },
      { name: "Dhi Qar", state_code: "DQ" },
      { name: "Diyala", state_code: "DI" },
      { name: "Dohuk", state_code: "DA" },
      { name: "Erbil", state_code: "AR" },
      { name: "Karbala", state_code: "KA" },
      { name: "Kirkuk", state_code: "KI" },
      { name: "Maysan", state_code: "MA" },
      { name: "Najaf", state_code: "NA" },
      { name: "Nineveh", state_code: "NI" },
      { name: "Saladin", state_code: "SD" },
      { name: "Sulaymaniyah", state_code: "SU" },
      { name: "Wasit", state_code: "WA" }
    ],
    capital: "Baghdad",
    name: "Iraq"
  },
  ...
  },
  {
    ...
    states: [
      ...
      { name: "Agrigento", state_code: "AG" },
      { name: "Alessandria", state_code: "AL" },
      { name: "Ancona", state_code: "AN" },
      { name: "Aosta Valley", state_code: "23" },
      { name: "Apulia", state_code: "75" },
      { name: "Ascoli Piceno", state_code: "AP" },
      { name: "Asti", state_code: "AT" },
      { name: "Avellino", state_code: "AV" },
      { name: "Barletta-Andria-Trani", state_code: "BT" },
      { name: "Basilicata", state_code: "77" },
      { name: "Belluno", state_code: "BL" },
      { name: "Benevento", state_code: "BN" },
      { name: "Bergamo", state_code: "BG" },
      { name: "Biella", state_code: "BI" },
      { name: "Brescia", state_code: "BS" },
      { name: "Brindisi", state_code: "BR" },
      { name: "Calabria", state_code: "78" },
      { name: "Caltanissetta", state_code: "CL" },
      { name: "Campania", state_code: "72" },
      { name: "Campobasso", state_code: "CB" },
      { name: "Caserta", state_code: "CE" },
      { name: "Catanzaro", state_code: "CZ" },
      { name: "Chieti", state_code: "CH" },
      { name: "Como", state_code: "CO" },
      { name: "Cosenza", state_code: "CS" },
      { name: "Cremona", state_code: "CR" },
      { name: "Crotone", state_code: "KR" },
      { name: "Cuneo", state_code: "CN" },
      { name: "Emilia-Romagna", state_code: "45" },
      { name: "Enna", state_code: "EN" },
      { name: "Fermo", state_code: "FM" },
      { name: "Ferrara", state_code: "FE" },
      { name: "Foggia", state_code: "FG" },
      { name: "Forlì-Cesena", state_code: "FC" },
      { name: "Friuli–Venezia Giulia", state_code: "36" },
      { name: "Frosinone", state_code: "FR" },
      { name: "Gorizia", state_code: "GO" },
      { name: "Grosseto", state_code: "GR" },
      { name: "Imperia", state_code: "IM" },
      { name: "Isernia", state_code: "IS" },
      { name: "L'Aquila", state_code: "AQ" },
      { name: "La Spezia", state_code: "SP" },
      { name: "Latina", state_code: "LT" },
      { name: "Lazio", state_code: "62" },
      { name: "Lecce", state_code: "LE" },
      { name: "Lecco", state_code: "LC" },
      { name: "Liguria", state_code: "42" },
      { name: "Livorno", state_code: "LI" },
      { name: "Lodi", state_code: "LO" },
      { name: "Lombardy", state_code: "25" },
      { name: "Lucca", state_code: "LU" },
      { name: "Macerata", state_code: "MC" },
      { name: "Mantua", state_code: "MN" },
      { name: "Marche", state_code: "57" },
      { name: "Massa and Carrara", state_code: "MS" },
      { name: "Matera", state_code: "MT" },
      { name: "Medio Campidano", state_code: "VS" },
      { name: "Modena", state_code: "MO" },
      { name: "Molise", state_code: "67" },
      { name: "Monza and Brianza", state_code: "MB" },
      { name: "Novara", state_code: "NO" },
      { name: "Nuoro", state_code: "NU" },
      { name: "Oristano", state_code: "OR" },
      { name: "Padua", state_code: "PD" },
      { name: "Palermo", state_code: "PA" },
      { name: "Parma", state_code: "PR" },
      { name: "Pavia", state_code: "PV" },
      { name: "Perugia", state_code: "PG" },
      { name: "Pesaro and Urbino", state_code: "PU" },
      { name: "Pescara", state_code: "PE" },
      { name: "Piacenza", state_code: "PC" },
      { name: "Piedmont", state_code: "21" },
      { name: "Pisa", state_code: "PI" },
      { name: "Pistoia", state_code: "PT" },
      { name: "Pordenone", state_code: "PN" },
      { name: "Potenza", state_code: "PZ" },
      { name: "Prato", state_code: "PO" },
      { name: "Ragusa", state_code: "RG" },
      { name: "Ravenna", state_code: "RA" },
      { name: "Reggio Emilia", state_code: "RE" },
      { name: "Rieti", state_code: "RI" },
      { name: "Rimini", state_code: "RN" },
      { name: "Rovigo", state_code: "RO" },
      { name: "Salerno", state_code: "SA" },
      { name: "Sardinia", state_code: "88" },
      { name: "Sassari", state_code: "SS" },
      { name: "Savona", state_code: "SV" },
      { name: "Sicily", state_code: "82" },
      { name: "Siena", state_code: "SI" },
      { name: "Siracusa", state_code: "SR" },
      { name: "Sondrio", state_code: "SO" },
      { name: "South Sardinia", state_code: "SU" },
      { name: "Taranto", state_code: "TA" },
      { name: "Teramo", state_code: "TE" },
      { name: "Terni", state_code: "TR" },
      { name: "Trapani", state_code: "TP" },
      { name: "Trentino-South Tyrol", state_code: "32" },
      { name: "Treviso", state_code: "TV" },
      { name: "Trieste", state_code: "TS" },
      { name: "Tuscany", state_code: "52" },
      { name: "Udine", state_code: "UD" },
      { name: "Umbria", state_code: "55" },
      { name: "Varese", state_code: "VA" },
      { name: "Veneto", state_code: "34" },
      { name: "Verbano-Cusio-Ossola", state_code: "VB" },
      { name: "Vercelli", state_code: "VC" },
      { name: "Verona", state_code: "VR" },
      { name: "Vibo Valentia", state_code: "VV" },
      { name: "Vicenza", state_code: "VI" },
      { name: "Viterbo", state_code: "VT" }
    ],
    capital: "Rome",
    name: "Italy"
  },
  ...
  { code: "JE", states: [], capital: "Saint Helier", name: "Jersey" },
  {
    code: "JO",
    states: [
      { name: "Ajloun", state_code: "AJ" },
      { name: "Amman", state_code: "AM" },
      { name: "Aqaba", state_code: "AQ" },
      { name: "Balqa", state_code: "BA" },
      { name: "Irbid", state_code: "IR" },
      { name: "Jerash", state_code: "JA" },
      { name: "Karak", state_code: "KA" },
      { name: "Ma'an", state_code: "MN" },
      { name: "Madaba", state_code: "MD" },
      { name: "Mafraq", state_code: "MA" },
      { name: "Tafilah", state_code: "AT" },
      { name: "Zarqa", state_code: "AZ" }
    ],
    capital: "Amman",
    name: "Jordan"
  },
  ...
  },
  {
    code: "XK",
    states: [
      { name: "Đakovica District (Gjakove)", state_code: "XDG" },
  ...
  },
  {
    ...
    states: [
      ...
      { name: "Al Farwaniyah", state_code: "FA" },
      { name: "Al Jahra", state_code: "JA" },
      { name: "Capital", state_code: "KU" },
      { name: "Hawalli", state_code: "HA" },
      { name: "Mubarak Al-Kabeer", state_code: "MU" }
    ],
    capital: "Kuwait City",
    name: "Kuwait"
  },
  ...
  },
  {
    code: "LB",
    states: [
      { name: "Akkar", state_code: "AK" },
      { name: "Baalbek-Hermel", state_code: "BH" },
      { name: "Beirut", state_code: "BA" },
      { name: "Beqaa", state_code: "BI" },
      { name: "Mount Lebanon", state_code: "JL" },
      { name: "Nabatieh", state_code: "NA" },
      { name: "North", state_code: "AS" },
      { name: "South", state_code: "JA" }
    ],
    capital: "Beirut",
    name: "Lebanon"
  },
  ...
  { code: "MO", states: [], capital: "Macao", name: "Macau S.A.R." },
  {
    code: "MK",
    states: [
  ...
  { code: "MQ", states: [], capital: "Fort-de-France", name: "Martinique" },
  {
    code: "MR",
    states: [
      { name: "Adrar", state_code: "07" },
      { name: "Assaba", state_code: "03" },
      { name: "Brakna", state_code: "05" },
      { name: "Dakhlet Nouadhibou", state_code: "08" },
      { name: "Gorgol", state_code: "04" },
      { name: "Guidimaka", state_code: "10" },
      { name: "Hodh Ech Chargui", state_code: "01" },
      { name: "Hodh El Gharbi", state_code: "02" },
      { name: "Inchiri", state_code: "12" },
      { name: "Nouakchott-Nord", state_code: "14" },
      { name: "Nouakchott-Ouest", state_code: "13" },
      { name: "Nouakchott-Sud", state_code: "15" },
      { name: "Tagant", state_code: "09" },
      { name: "Tiris Zemmour", state_code: "11" },
      { name: "Trarza", state_code: "06" }
    ],
    capital: "Nouakchott",
    name: "Mauritania"
  },
  {
    code: "MU",
    states: [
      { name: "Agalega Islands", state_code: "AG" },
      { name: "Black River", state_code: "BL" },
      { name: "Flacq", state_code: "FL" },
      { name: "Grand Port", state_code: "GP" },
      { name: "Moka", state_code: "MO" },
      { name: "Pamplemousses", state_code: "PA" },
      { name: "Plaines Wilhems", state_code: "PW" },
      { name: "Port Louis", state_code: "PL" },
      { name: "Rivière du Rempart", state_code: "RR" },
      { name: "Rodrigues Island", state_code: "RO" },
      { name: "Saint Brandon Islands", state_code: "CC" },
      { name: "Savanne", state_code: "SA" }
    ],
    capital: "Port Louis",
    name: "Mauritius"
  },
  { code: "YT", states: [], capital: "Mamoudzou", name: "Mayotte" },
  {
    code: "MX",
    states: [
  ...
  { code: "MS", states: [], capital: "Plymouth", name: "Montserrat" },
  {
    code: "MA",
    states: [
      { name: "Agadir-Ida-Ou-Tanane", state_code: "AGD" },
  ...
  { code: "NC", states: [], capital: "Noumea", name: "New Caledonia" },
  {
    code: "NZ",
    states: [
  ...
  { code: "NU", states: [], capital: "Alofi", name: "Niue" },
  { code: "NF", states: [], capital: "Kingston", name: "Norfolk Island" },
  {
    code: "KP",
    states: [
  ...
  },
  {
    code: "NO",
    states: [
      { name: "Agder", state_code: "42" },
      { name: "Innlandet", state_code: "34" },
      ...
      { name: "Troms og Finnmark", state_code: "54" },
      { name: "Trøndelag", state_code: "50" },
      { name: "Vestfold og Telemark", state_code: "38" },
      { name: "Vestland", state_code: "46" },
      { name: "Viken", state_code: "30" }
    ],
    capital: "Oslo",
    name: "Norway"
  },
  {
    code: "OM",
    states: [
      { name: "Ad Dakhiliyah", state_code: "DA" },
      { name: "Ad Dhahirah", state_code: "ZA" },
      { name: "Al Batinah North", state_code: "BS" },
      { name: "Al Batinah Region", state_code: "BA" },
      { name: "Al Batinah South", state_code: "BJ" },
      { name: "Al Buraimi", state_code: "BU" },
      { name: "Al Wusta", state_code: "WU" },
      { name: "Ash Sharqiyah North", state_code: "SS" },
      { name: "Ash Sharqiyah Region", state_code: "SH" },
      { name: "Ash Sharqiyah South", state_code: "SJ" },
      { name: "Dhofar", state_code: "ZU" },
      { name: "Musandam", state_code: "MU" },
      { name: "Muscat", state_code: "MA" }
    ],
    capital: "Muscat",
    name: "Oman"
  },
  ...
  },
  {
    code: "PS",
    states: [
      { name: "Bethlehem", state_code: "BTH" },
      { name: "Deir El Balah", state_code: "DEB" },
      { name: "Gaza", state_code: "GZA" },
      { name: "Hebron", state_code: "HBN" },
      { name: "Jenin", state_code: "JEN" },
      { name: "Jericho and Al Aghwar", state_code: "JRH" },
      { name: "Jerusalem", state_code: "JEM" },
      { name: "Khan Yunis", state_code: "KYS" },
      { name: "Nablus", state_code: "NBS" },
      { name: "North Gaza", state_code: "NGZ" },
      { name: "Qalqilya", state_code: "QQA" },
      { name: "Rafah", state_code: "RFH" },
      { name: "Ramallah", state_code: "RBH" },
      { name: "Salfit", state_code: "SLT" },
      { name: "Tubas", state_code: "TBS" },
      { name: "Tulkarm", state_code: "TKM" }
    ],
  ...
  },
  {
    ...
    states: [
      ...
      { name: "Cordillera Administrative", state_code: "15" },
      { name: "Cotabato", state_code: "NCO" },
      { name: "Davao", state_code: "11" },
      ...
      { name: "Western Samar", state_code: "WSA" },
  ...
  { code: "PN", states: [], capital: "Adamstown", name: "Pitcairn Island" },
  {
    code: "PL",
    states: [
  ...
  },
  {
    code: "PR",
    states: [
      { name: "Arecibo", state_code: "AR" },
      { name: "Bayamon", state_code: "BY" },
      { name: "Caguas", state_code: "CG" },
      { name: "Carolina", state_code: "CL" },
      { name: "Guaynabo", state_code: "GN" },
      { name: "Mayagüez", state_code: "MG" },
      { name: "Ponce", state_code: "PO" },
      { name: "San Juan", state_code: "SJ" },
      { name: "Toa Baja", state_code: "TB" },
      { name: "Trujillo Alto", state_code: "TA" }
    ],
    capital: "San Juan",
    name: "Puerto Rico"
  },
  ...
  { code: "RE", states: [], capital: "Saint-Denis", name: "Reunion" },
  {
    code: "RO",
    states: [
  ...
  { code: "SH", states: [], capital: "Jamestown", name: "Saint Helena" },
  {
    code: "KN",
    states: [
  ...
  { code: "BL", states: [], capital: "Gustavia", name: "Saint-Barthelemy" },
  {
    code: "MF",
    states: [],
    capital: "Marigot",
  ...
  { code: "GS", states: [], capital: "Grytviken", name: "South Georgia" },
  {
    code: "KR",
    states: [
  ...
  },
  {
    code: "ES",
    states: [
      { name: "A Coruña", state_code: "C" },
      { name: "Albacete", state_code: "AB" },
      { name: "Alicante", state_code: "A" },
      { name: "Almeria", state_code: "AL" },
      { name: "Araba", state_code: "VI" },
      { name: "Asturias", state_code: "O" },
      { name: "Ávila", state_code: "AV" },
      { name: "Badajoz", state_code: "BA" },
      { name: "Barcelona", state_code: "B" },
      { name: "Bizkaia", state_code: "BI" },
      { name: "Burgos", state_code: "BU" },
      { name: "Caceres", state_code: "CC" },
      { name: "Cádiz", state_code: "CA" },
      { name: "Cantabria", state_code: "S" },
      { name: "Castellón", state_code: "CS" },
      { name: "Ciudad Real", state_code: "CR" },
      { name: "Córdoba", state_code: "CO" },
      { name: "Cuenca", state_code: "CU" },
      { name: "Gipuzkoa", state_code: "SS" },
      { name: "Girona", state_code: "GI" },
      { name: "Granada", state_code: "GR" },
      { name: "Guadalajara", state_code: "GU" },
      { name: "Huelva", state_code: "H" },
      { name: "Huesca", state_code: "HU" },
      { name: "Islas Baleares", state_code: "PM" },
      { name: "Jaén", state_code: "J" },
      { name: "La Rioja", state_code: "LO" },
      { name: "Las Palmas", state_code: "GC" },
      { name: "Léon", state_code: "LE" },
      { name: "Lleida", state_code: "L" },
      { name: "Lugo", state_code: "LU" },
      { name: "Madrid", state_code: "M" },
      { name: "Málaga", state_code: "MA" },
      { name: "Murcia", state_code: "MU" },
      { name: "Navarra", state_code: "NA" },
      { name: "Ourense", state_code: "OR" },
      { name: "Palencia", state_code: "P" },
      { name: "Pontevedra", state_code: "PO" },
      { name: "Salamanca", state_code: "SA" },
      { name: "Santa Cruz de Tenerife", state_code: "TF" },
      { name: "Segovia", state_code: "SG" },
      { name: "Sevilla", state_code: "SE" },
      { name: "Soria", state_code: "SO" },
      { name: "Tarragona", state_code: "T" },
      { name: "Teruel", state_code: "TE" },
      { name: "Toledo", state_code: "TO" },
      { name: "Valencia", state_code: "V" },
      { name: "Valladolid", state_code: "VA" },
      { name: "Zamora", state_code: "ZA" },
      { name: "Zaragoza", state_code: "Z" }
    ],
    capital: "Madrid",
    name: "Spain"
  },
  ...
  },
  {
    code: "SY",
    states: [
      { name: "Al-Hasakah", state_code: "HA" },
      { name: "Al-Raqqah", state_code: "RA" },
      { name: "Aleppo", state_code: "HL" },
      { name: "As-Suwayda", state_code: "SU" },
      { name: "Damascus", state_code: "DI" },
      { name: "Daraa", state_code: "DR" },
      { name: "Deir ez-Zor", state_code: "DY" },
      { name: "Hama", state_code: "HM" },
      { name: "Homs", state_code: "HI" },
      { name: "Idlib", state_code: "ID" },
      { name: "Latakia", state_code: "LA" },
      { name: "Quneitra", state_code: "QU" },
      { name: "Rif Dimashq", state_code: "RD" },
      { name: "Tartus", state_code: "TA" }
    ],
    capital: "Damascus",
    name: "Syria"
  },
  ...
  { code: "TK", states: [], capital: "", name: "Tokelau" },
  {
    code: "TO",
    states: [
  ...
  },
  {
    code: "TN",
    states: [
      { name: "Ariana", state_code: "12" },
      { name: "Ben Arous", state_code: "13" },
      { name: "Bizerte", state_code: "23" },
      { name: "Gabès", state_code: "81" },
      { name: "Gafsa", state_code: "71" },
      { name: "Jendouba", state_code: "32" },
      { name: "Kairouan", state_code: "41" },
      { name: "Kasserine", state_code: "42" },
      { name: "Kassrine", state_code: "31" },
      { name: "Kebili", state_code: "73" },
      { name: "Kef", state_code: "33" },
      { name: "Mahdia", state_code: "53" },
      { name: "Manouba", state_code: "14" },
      { name: "Medenine", state_code: "82" },
      { name: "Monastir", state_code: "52" },
      { name: "Nabeul", state_code: "21" },
      { name: "Sfax", state_code: "61" },
      { name: "Sidi Bouzid", state_code: "43" },
      { name: "Siliana", state_code: "34" },
      { name: "Sousse", state_code: "51" },
      { name: "Tataouine", state_code: "83" },
      { name: "Tozeur", state_code: "72" },
      { name: "Tunis", state_code: "11" },
      { name: "Zaghouan", state_code: "22" }
    ],
    capital: "Tunis",
    name: "Tunisia"
  },
  ...
  },
  {
    code: "VI",
    states: [
      { name: "Saint Croix", state_code: "SC" },
  ...
  { code: "EH", states: [], capital: "El-Aaiun", name: "Western Sahara" },
  {
    code: "YE",
    states: [
      { name: "'Adan", state_code: "AD" },
      { name: "'Amran", state_code: "AM" },
      { name: "Abyan", state_code: "AB" },
      { name: "Al Bayda'", state_code: "BA" },
      { name: "Al Hudaydah", state_code: "HU" },
      { name: "Al Jawf", state_code: "JA" },
      { name: "Al Mahrah", state_code: "MR" },
      ...
      { name: "Ma'rib", state_code: "MA" },
      { name: "Raymah", state_code: "RA" },
      { name: "Saada", state_code: "SD" },
      { name: "Sana'a", state_code: "SN" },
      { name: "Sana'a", state_code: "SA" },
      { name: "Shabwah", state_code: "SH" },
      { name: "Socotra", state_code: "SU" },
      { name: "Ta'izz", state_code: "TA" }
    ],
    capital: "Sanaa",
    name: "Yemen"
  },
